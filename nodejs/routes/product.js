...
router.get('/redis/product/list', async (req, res, next) => {
...
router.post('/redis/product/registration', async (req, res, next) => {
  await redis_client.connect();
...
router.post('/redis/product/delete', async (req, res, next) => {
  await redis_client.connect();
